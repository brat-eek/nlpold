...
def softmax(x):  # here each row is an input and cols are corresponding h(x) for each of 2 classes
	"""
	You might find the tensorflow functions tf.exp, tf.reduce_max,
	tf.reduce_sum, tf.expand_dims useful.
	Args:
...
def cross_entropy_loss(y, yhat):
	...
	be of dtype tf.float32 and are corresponding classes probabilities.
